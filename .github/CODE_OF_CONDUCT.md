...
5. **Claiming AI-generated evidence as human-authored.**
6. **Bypassing the engine's human gates in shared or collaborative runs.**
...
report a possible violation, open a GitHub Issue marked **[CoC]** or
contact the maintainer directly via GitHub.

This project has one maintainer, not a moderation team: Mohd Saif Hussain
takes reports of violations seriously and will make every effort to
respond in a timely manner, reviewing messages, logs, or other evidence as
the report requires. Investigation and enforcement are kept as transparent
as possible while prioritizing safety and confidentiality — enforcement
actions are carried out in private with the involved parties, but
...
community as a whole. Depending on the severity of a violation, lower
...
3) Temporary Suspension
   1) Event: A pattern of repeated violation which the maintainer has
...
4) Permanent Ban
   1) Event: A pattern of repeated code of conduct violations that other
      ...
      serious that the maintainer determines there is no way to keep the
...
maintainer's ability to use their discretion and judgment, in keeping with
